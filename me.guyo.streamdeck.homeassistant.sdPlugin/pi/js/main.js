...
function connectElgatoStreamDeckSocket(inPort, inUUID, inRegisterEvent, inInfo, inActionInfo) {
    ...
    if (action === 'me.guyo.hass.toggle' || action === 'me.guyo.hass.state' || action === 'me.guyo.hass.light_color') {
        pi = new EntityIDPropertyInspector(inUUID, language, action);
    }
    else if (action === 'me.guyo.hass.service') {
        pi = new CallServicePropertyInspector(inUUID, language, action);
    }
    else {
        pi = new PropertyInspector(inUUID, language, action);
    }
